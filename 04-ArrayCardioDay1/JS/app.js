...
const bornInFifteens = inventors.filter(inventor => inventor.year > 1499 && inventor.year < 1600);
...
const livedByInventor = inventors.sort((a, b) => {
    return (a.passed - a.year) - (b.passed - b.year)
});

// 5. Sort the inventors by years lived (opt by wesbos)
